...
<div id="mainBody">
	...
	<div id="legalNotice">
		<h4>Usage</h4>
<p>This website copyright notice and disclaimer can be used by any website or blog or ecommerce store. All websites can use this to indicate to readers and users of their website the legal conditions that restrict the use of information and any other sensitive data or details displayed on the website.</p>
<h4>Execution</h4>
<p>This Website Copyright Notice and Disclaimer can be displayed on the website in a prominent place at the footer of the website. It indicates to all users the confidence they can have that any information they have provided to the owners of the website will not under any circumstances be disclosed to others, as provided for in the particulars described in the privacy policy.</p>	</div>
	</div>
</div>
</div>
</div>
