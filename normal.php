	...
	<div id="sidebar" class="span3">
		...
		<br/>
		  <div class="thumbnail">
			...
			<div class="caption">
			  <h5>Panasonic</h5>
				<h4 style="text-align:center"><a class="btn" href="product_details.php"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#"> ₹ 500.00</a></h4>
			</div>
		  </div><br/>
			<div class="thumbnail">
...
<!-- Sidebar end=============================================== -->
	...
	<hr class="soft"/>
	<h4>Step 1: Order Processing</h4>

<p>Order processing is a term for a set of activities needed to process the order made by the customer. Every purchase is tied to a specific order and tracking ID for the item to be delivered. Different teams have different tasks to perform in processing the order. The production and logistics team updates the inventory, closes the purchase order, and assign the tasks to the packaging and delivery team.</p>

<h4>Step 2: Order Packaging</h4>
The next step is to pack the items properly before the ultimate shipping. Packaging has two-fold purposes; firstly, it prevents the item from getting damaged, and secondly, it helps create brand value. Some of the standard packaging options include boxes, packets, envelops, and so on. The packaging is done based on the type of item.

Packaging should always be user-friendly and less cumbersome. However, it should be sturdy and durable enough to prevent the product from damage during transit. Moreover, your brand logo (if there is any) needs to be distinctly visible on the package as it helps increase brand value and retention.

Shiprocket - India's number 1 shipping solution
<h4>Step 3: Logistics and Delivery</h4>
<p>It is the third and most crucial step in the whole shipping process. eCommerce companies require a reliable logistics process for seamless and timely delivery to the customer. In this case, employing or partnering with a reliable and reputed third-party logistics or courier agency helps. They will deliver the items on your behalf. eCommerce giants like Amazon have their own logistics division to deliver orders. Others may opt for online shipping aggregators like Shiprocket, which provides an option to choose from multiple shipping partners to the sellers, and that too, on pre-negotiated shipping charges.</p>

<h4>Step 4: Returns</h4>
<p>Last but not least, shipping also involves processing returns. After the customer returns the items due to various reasons, the logistics agency ships it back to the retailer, and the returns process starts. Based on the return terms and conditions, the refund is processed.

The increasing popularity of the digital platform has led to the rapid growth of eCommerce in the world. With innovative shipping techniques coming almost every day, it is expected to benefit both businesses and customers.

Stay tuned to our blog for more useful updates related to advancements in the industry and tips on how to grow your eCommerce business. Shiprocket is the #1 eCommerce shipping solution in India, providing hassle-free shipping experience to thousands of online sellers. Click here for more details.</p>
</div>
</div></div>
</div>
<!-- MainBody End ============================= -->
